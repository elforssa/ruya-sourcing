    ...
    <div className="min-h-screen">
      ...
      <header style={{ background: "linear-gradient(135deg, #071526 0%, #0B1F3B 100%)" }}
        ...
        <div className="container mx-auto flex h-16 items-center justify-between px-6">
          {/* Logo */}
          <Image src="/logo.png" alt="RUYA" width={160} height={50} priority loading="eager" quality={85} className="h-8 w-auto" />
          {/* CTA */}
          <Link
            href="/auth/login"
      ...
      >
        ...
        <div className="relative mx-auto max-w-3xl">
          {/* Logo */}
          <Image src="/logo.png" alt="RUYA" width={160} height={50} priority loading="eager" quality={85} className="h-20 w-auto mx-auto mb-6" />
